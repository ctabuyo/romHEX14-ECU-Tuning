...
class TRWLucasPlugin : public QObject, public Checksum::IChecksumPlugin {
    Q_OBJECT
...
public:
    ...
    uint32_t devNum() const override { return 163; }
    QVector<uint32_t> supportedDevNums() const override { return { 163, 164 }; }
    QString pluginId() const override { return QStringLiteral("trw_lucas"); }
    QString name() const override { return QStringLiteral("TRW / Lucas DCN2 / EPIC"); }
    QString description() const override { return QStringLiteral("TRW / LUCAS DCN2 / EPIC - PSA / RENAULT"); }
