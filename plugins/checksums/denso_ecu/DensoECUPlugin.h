...
class DensoECUPlugin : public QObject, public Checksum::IChecksumPlugin {
    Q_OBJECT
...
public:
    ...
    uint32_t devNum() const override { return 127; }
    QVector<uint32_t> supportedDevNums() const override { return { 127, 146, 161, 162 }; }
    QString pluginId() const override { return QStringLiteral("denso_ecu"); }
    QString name() const override { return QStringLiteral("Denso ECU (SH705x / 64F7058 / NEC 76F00xx)"); }
    QString description() const override { return QStringLiteral("DENSO SH705x / NEC - TOYOTA / MAZDA / NISSAN"); }
