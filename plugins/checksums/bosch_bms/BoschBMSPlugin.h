...
class BoschBMSPlugin : public QObject, public Checksum::IChecksumPlugin {
    Q_OBJECT
...
public:
    ...
    uint32_t devNum() const override { return 156; }
    QVector<uint32_t> supportedDevNums() const override { return { 156, 157, 158 }; }
    QString pluginId() const override { return QStringLiteral("bosch_bms"); }
    QString name() const override { return QStringLiteral("Bosch BMS (BMS-X / BMS-MP / BMS-KP)"); }
    QString description() const override { return QStringLiteral("BOSCH BMS-X / BMS-MP / BMS-KP - BMW MOTORRAD"); }
